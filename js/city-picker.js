        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '<a class="active" data-count="province">城市</a>' +
                    (this.includeDem('city') ? '<a data-count="city">地区</a>' : '') +
                    (this.includeDem('district') ? '<a data-count="district">路段</a>' : '') + '</div>' +
